# E1T1 — /roll command implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 RDX

1. Create src/handlers/roll.ts with Composer for /roll command
2. Generate cryptographically secure random integer (1-6) using SystemRandom
3. Send plain text reply with result
4. Write BotSpec test to tests/specs/E1T1.json
5. Append /roll command to tests/commands.json
6. Handle Telegram 429 errors with backoff retry
7. Add stdout logging for roll events
